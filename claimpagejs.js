...
window.onload = function(){
	...
	var replyclose = document.getElementById("replyspan");
...
function CreateReply(){
		...
		replyType.value = "norelate"
		var clarif = document.getElementById("lclarif");
		var counter = document.getElementById("lcounter");
		clarif.innerHTML = "Clarification";
		counter.innerHTML = "Counter";
		var relate = document.getElementById("relateID");
		relate.value=""
}
